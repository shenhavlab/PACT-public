%% run__rewMotionStatic =============================================
%
% function run__rewMotionStatic(exp)
%
%
%
%
...
function run__rewMotionStatic(name)
...
saveAs = sprintf('%s_rewMotionStatic', name)
likfun = 'lik_rewMotionStatic'
