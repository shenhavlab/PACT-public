function [lik, out] = lik_motionStatic(p, data, mu, nui, doprior, llopt)
...
% rt_X        = [ones(sum(rt_sel), 1), targ(rt_sel) - mean(targ(rt_sel)), dist(rt_sel)];
