%% run__adaptDualDyn =============================================
%
% function run__adaptDualDyn(exp)
%
%
%
%
...
function run__adaptDualDyn(name)
...
saveAs = sprintf('%s_adaptDualDyn', name)
likfun = 'lik_adaptDualDyn'
...
%  acc_{dist1CrtTarg}  =====================
np = np + 1;
paramName{np}   = 'acc_{dist1CrtTarg}';
link{np}        = @(x) x;
reg{np}         = [];
...
%  acc_{dist1CrtDist}  =====================
np = np + 1;
paramName{np}   = 'acc_{dist1CrtDist}';
link{np}        = @(x) x;
reg{np}         = [];
