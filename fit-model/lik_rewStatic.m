function [lik, out] = lik_rewStatic(p, data, mu, nui, doprior, llopt)
...
acc_X        = [...
    ones(sum(acc_sel), 1), prevResp(acc_sel), respTarg(acc_sel), respDist(acc_sel),...
