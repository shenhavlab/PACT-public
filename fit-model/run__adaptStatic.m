...
function run__adaptStatic(name)
...
saveAs = sprintf('%s_adaptStatic', name)
likfun = 'lik_adaptStatic'
...
if ~strcmp(name, 'exp1')
    ...
    np = np + 1;
    paramName{np}   = 'rt_{distTarg1}';
    link{np}        = @(x) x;
    reg{np}         = [];
    
    np = np + 1;
    paramName{np}   = 'rt_{targDist1}';
    link{np}        = @(x) x;
    reg{np}         = [];
...
if ~strcmp(name, 'exp1')
    ...
    np = np + 1;
    paramName{np}   = 'acc_{distTarg1}';
    link{np}        = @(x) x;
    reg{np}         = [];
    
    np = np + 1;
    paramName{np}   = 'acc_{targDist1}';
    link{np}        = @(x) x;
    reg{np}         = [];
