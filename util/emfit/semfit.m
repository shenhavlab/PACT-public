...
fitparams.maxFminIter = 1e8;                            % fminunc max iterations
fitparams.maxFminEval = 1e8;                            % fminunc max evaluations
...
while 1;emit=emit+1; t0=tic;
    ...
    if ~isempty(savestr); eval(['save ' savestr ' D E V alpha stats emit musj nui fitparams']);end
